...
def calculate_split_info(path: str, label_dict: dict, rate: float = 0.2):
    ...
    train_data, train_label = read_csv_classes("DATA/imagenet", "train.csv")
    val_data, val_label = read_csv_classes("DATA/imagenet", "val.csv")
    test_data, test_label = read_csv_classes("DATA/imagenet", "test.csv")
...
def main():
    data_dir = "DATA/imagenet/"  # 指向数据集的根目录
