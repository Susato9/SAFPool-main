...
def run_tip_adapter_F(cfg, cache_keys, cache_values, test_features, test_labels, clip_weights, clip_model, train_loader_F):
    ...
    write_str=""
    log_name=str("vit_B_32") + "_" + str(str(cfg['shots']))+"_shots_" + str(year) + "_" + str(month) + "_" + str(day) + "_" + str(hour) + "_" + str(minute) + "_" + str(second) + ".txt"
    for train_idx in range(cfg['train_epoch']):
        ...
        with open("learing_rate.txt","a+") as f:
    ...
    with open("experiment/ori_model/"+log_name,"w") as f:
        f.write(write_str)
